...
<body>
    ...
    <section class="content">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='editar_genero.php?id=" . $row['id_genero'] . "'>Editar</a> | <a href='remover_genero.php?id=" . $row['id_genero'] . "'>Remover</a></td>";
                        echo "</tr>";
                    }
                } else {
        ...
        <div class="button-container">
            ...
            <a href="../filmes/filmes.php"><button>Voltar</button></a>
        </div>
    </section>
</body>
</html>
